...
export async function backupInstallPath(installPath) {
...
export async function restoreFromBackup(installPath, backupPath) {
...
export function pruneOldBackups(installPath) {
